            ...
            <section class="content">
                ...
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="box-title">update Student Data</h4>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                                        ...
                                                        <div class="controls">
                                                            <select name="religion" id="religion" required=""
                                                                ...
                                                                <option value="Kristen"
                                                                    {{ $editData['student']['religion'] == 'Christian' ? 'selected' : '' }}>
                                                                    Christian</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="date" name="birth" class="form-control"
                                                                required="" value="{{ $editData['student']['birth'] }}">
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <h5>Major (Optional)</h5>
                                                        <div class="controls">
                                                            <select name="group_id" class="form-control">
                                                                <option value="" selected="" disabled="">
                                                                    Choose a Major</option>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            ...
                                                            <a href="{{ route('student.registration.promotion', $editData->student_id) }}"
                                                                class="btn btn-success ml-10">Upgrade</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
